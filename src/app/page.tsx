  ...
  return (
    <div className="font-sans min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-950 text-gray-800 dark:text-gray-100">
      {/* Navbar */}
        ...
        <GridBackground />
          {/* Main Content */}
          <main className="flex flex-col gap-8 items-center justify-center flex-1 px-6 text-center relative z-10">
            <Image
              src="/next.svg"
      ...
      {/* Footer */}
      <footer className="w-full text-center py-6 bg-white dark:bg-gray-900 text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 z-100">
